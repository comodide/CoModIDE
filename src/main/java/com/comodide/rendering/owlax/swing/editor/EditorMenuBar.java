...
import com.comodide.rendering.owlax.swing.editor.EditorActions.AlignCellsAction;
import com.comodide.rendering.owlax.swing.editor.EditorActions.AutosizeAction;
import com.comodide.rendering.owlax.swing.editor.EditorActions.BackgroundAction;
import com.comodide.rendering.owlax.swing.editor.EditorActions.BackgroundImageAction;
import com.comodide.rendering.owlax.swing.editor.EditorActions.ColorAction;
import com.comodide.rendering.owlax.swing.editor.EditorActions.GridColorAction;
import com.comodide.rendering.owlax.swing.editor.EditorActions.GridStyleAction;
...
import com.comodide.rendering.owlax.swing.editor.EditorActions.OpenAction;
import com.comodide.rendering.owlax.swing.editor.EditorActions.PageBackgroundAction;
import com.comodide.rendering.owlax.swing.editor.EditorActions.PrintAction;
import com.comodide.rendering.owlax.swing.editor.EditorActions.PromptPropertyAction;
import com.comodide.rendering.owlax.swing.editor.EditorActions.PromptValueAction;
import com.comodide.rendering.owlax.swing.editor.EditorActions.RemoveExistingAxiomsAction;
import com.comodide.rendering.owlax.swing.editor.EditorActions.SaveAction;
import com.comodide.rendering.owlax.swing.editor.EditorActions.SaveOntologyAction;
import com.comodide.rendering.owlax.swing.editor.EditorActions.ScaleAction;
import com.comodide.rendering.owlax.swing.editor.EditorActions.SetLabelPositionAction;
import com.comodide.rendering.owlax.swing.editor.EditorActions.ToggleAction;
import com.comodide.rendering.owlax.swing.editor.EditorActions.ToggleCardinalityAxiom;
import com.comodide.rendering.owlax.swing.editor.EditorActions.ToggleDomainAxiom;
import com.comodide.rendering.owlax.swing.editor.EditorActions.ToggleExistentialAxiom;
import com.comodide.rendering.owlax.swing.editor.EditorActions.ToggleGridItem;
import com.comodide.rendering.owlax.swing.editor.EditorActions.ToggleOutlineItem;
import com.comodide.rendering.owlax.swing.editor.EditorActions.ToggleRangeAxiom;
import com.comodide.rendering.owlax.swing.editor.EditorActions.ToggleRulersItem;
...
public class EditorMenuBar extends JMenuBar {
	...
	public EditorMenuBar(final BasicGraphEditor editor) {
		...
		// PageSetupAction(), "/images/pagesetup.gif"));
		...
		// menu.add(editor.bind(mxResources.get("cardinalitySize"), new
		// PromptPropertyActionForCardinality(graph, "Cardinality")));
		menu.addSeparator();
...
//		menu.add(editor.bind(mxResources.get("width"), new ZoomPolicyAction(mxGraphComponent.ZOOM_POLICY_WIDTH)));
		 ...
		 * StylesheetAction("/resources/basic-style.xml")));
		 * submenu.add(editor.bind(mxResources.get("defaultStyle"), new
		 * StylesheetAction( "/resources/default-style.xml")));
		 */
		 ...
		 * 
		 * submenu.add(new TogglePropertyItem(graphComponent,
		 * mxResources.get("preferPageSize"), "PreferPageSize", true, new
		 * ActionListener() { public void actionPerformed(ActionEvent e) {
		 * graphComponent.zoomAndCenter(); } }));
		 * 
		 * // TODO: This feature is not yet implemented //submenu.add(new
		 * TogglePropertyItem(graphComponent, mxResources // .get("pageBreaks"),
		...
		// submenu.add(new TogglePropertyItem(graphComponent,
		// mxResources.get("zoomToSelection"), "KeepSelectionVisibleOnZoom",
		// true));
		...
		/*
		 * submenu.add(new TogglePropertyItem(graphComponent,
		 * mxResources.get("centerPage"), "CenterPage", true, new
		 * ActionListener() { public void actionPerformed(ActionEvent e) { if
		 * (graphComponent.isPageVisible() && graphComponent.isCenterPage()) {
		 * graphComponent.zoomAndCenter(); } } }));
		 * 
		 * menu.addSeparator();
		 * 
		 ...
		 * 
		 * submenu.add(new TogglePropertyItem(graphComponent,
		 * mxResources.get("dragEnabled"), "DragEnabled")); submenu.add(new
		 ...
		 * 
		 * submenu.add(new TogglePropertyItem(graphComponent,
		 * mxResources.get("connectable"), "Connectable")); submenu.add(new
		 * TogglePropertyItem(graph, mxResources.get("connectableEdges"),
		 * "ConnectableEdges"));
		 * 
		 * submenu.addSeparator();
		 * 
		 * submenu.add(new ToggleCreateTargetItem(editor,
		 * mxResources.get("createTarget"))); submenu.add(new
		 * TogglePropertyItem(graph, mxResources.get("disconnectOnMove"),
		 * "DisconnectOnMove"));
		 * 
		 * submenu.addSeparator();
		 * 
		 ...
		 * 
		 * submenu.add(new TogglePropertyItem(graph,
		 * mxResources.get("allowLoops"), "AllowLoops")); submenu.add(new
		 * TogglePropertyItem(graph, mxResources.get("multigraph"),
		 * "Multigraph"));
		 */
		 ...
		 * 
		 * for (int i = 0; i < lafs.length; i++) { final String clazz =
		 * lafs[i].getClassName();
		 * 
		...
		/*
		 * menu = add(new JMenu("Generate")); menu.add(editor.bind("Null Graph",
		 * new InsertGraph(GraphType.NULL, aGraph))); menu.add(editor.bind(
		 * "Complete Graph", new InsertGraph(GraphType.COMPLETE, aGraph)));
		 * menu.add(editor.bind("Grid", new InsertGraph(GraphType.GRID,
		 * aGraph))); menu.add(editor.bind("Bipartite", new
		 * InsertGraph(GraphType.BIPARTITE, aGraph))); menu.add(editor.bind(
		 * "Complete Bipartite", new InsertGraph(GraphType.COMPLETE_BIPARTITE,
		 * aGraph))); menu.add(editor.bind("Knight's Graph", new
		 * InsertGraph(GraphType.KNIGHT, aGraph))); menu.add(editor.bind(
		 * "King's Graph", new InsertGraph(GraphType.KING, aGraph)));
		 * menu.add(editor.bind("Petersen", new InsertGraph(GraphType.PETERSEN,
		 * aGraph))); menu.add(editor.bind("Path", new
		 * InsertGraph(GraphType.PATH, aGraph))); menu.add(editor.bind("Star",
		 * new InsertGraph(GraphType.STAR, aGraph)));
		 * menu.add(editor.bind("Wheel", new InsertGraph(GraphType.WHEEL,
		 * aGraph))); menu.add(editor.bind("Friendship Windmill", new
		 * InsertGraph(GraphType.FRIENDSHIP_WINDMILL, aGraph)));
		 * menu.add(editor.bind("Full Windmill", new
		 * InsertGraph(GraphType.FULL_WINDMILL, aGraph))); menu.add(editor.bind(
		 * "Knight's Tour", new InsertGraph(GraphType.KNIGHT_TOUR, aGraph)));
		 * menu.addSeparator(); menu.add(editor.bind("Simple Random", new
		 * InsertGraph(GraphType.SIMPLE_RANDOM, aGraph))); menu.add(editor.bind(
		 * "Simple Random Tree", new InsertGraph(GraphType.SIMPLE_RANDOM_TREE,
		 * aGraph))); menu.addSeparator(); menu.add(editor.bind("Reset Style",
		 * new InsertGraph(GraphType.RESET_STYLE, aGraph)));
		 * 
		 * menu = add(new JMenu("Analyze")); menu.add(editor.bind("Is Connected"
		 * , new AnalyzeGraph(AnalyzeType.IS_CONNECTED, aGraph)));
		 * menu.add(editor.bind("Is Simple", new
		 * AnalyzeGraph(AnalyzeType.IS_SIMPLE, aGraph))); menu.add(editor.bind(
		 * "Is Directed Cyclic", new
		 ...
		 * InsertGraph(GraphType.BFS_DIR, aGraph))); menu.add(editor.bind(
		 * "BFS Undirected", new InsertGraph(GraphType.BFS_UNDIR, aGraph)));
		 * menu.add(editor.bind("DFS Directed", new
		 * InsertGraph(GraphType.DFS_DIR, aGraph))); menu.add(editor.bind(
		 * "DFS Undirected", new InsertGraph(GraphType.DFS_UNDIR, aGraph)));
		 ...
		 * aGraph))); menu.add(editor.bind("Bellman-Ford", new
		 ...
		 * AnalyzeGraph(AnalyzeType.COMPONENTS, aGraph))); menu.add(editor.bind(
		 * "Make Connected", new AnalyzeGraph(AnalyzeType.MAKE_CONNECTED,
		 * aGraph))); menu.add(editor.bind("Make Simple", new
		 * AnalyzeGraph(AnalyzeType.MAKE_SIMPLE, aGraph)));
		 * menu.add(editor.bind("Is Tree", new AnalyzeGraph(AnalyzeType.IS_TREE,
		 * aGraph))); menu.add(editor.bind("One Spanning Tree", new
		 ...
		 * aGraph))); menu.add(editor.bind("Outdegree", new
		 * InsertGraph(GraphType.OUTDEGREE, aGraph))); menu.add(editor.bind(
		 * "Is cut vertex", new InsertGraph(GraphType.IS_CUT_VERTEX, aGraph)));
		 ...
		 * AnalyzeGraph(AnalyzeType.GET_SINKS, aGraph))); menu.add(editor.bind(
		 * "Is biconnected", new AnalyzeGraph(AnalyzeType.IS_BICONNECTED,
		 * aGraph)));
		 * 
		 */
		...
		// item = menu.add(new JMenuItem(mxResources.get("howToUse")));
		// item.addActionListener(new ActionListener() {
		// public void actionPerformed(ActionEvent e) {
		// editor.howToUse();
		// }
	...
	public static void populateShapeMenu(JMenu menu, BasicGraphEditor editor) {
		...
		menu.add(editor.bind(mxResources.get("enterGroup"), mxGraphActions.getEnterGroupAction(), "/images/down.gif"));

		menu.addSeparator();

		menu.add(editor.bind(mxResources.get("group"), mxGraphActions.getGroupAction(), "/images/group.gif"));
		menu.add(editor.bind(mxResources.get("ungroup"), mxGraphActions.getUngroupAction(), "/images/ungroup.gif"));
		...
		menu.add(editor.bind(mxResources.get("collapse"), mxGraphActions.getCollapseAction(), "/images/collapse.gif"));
		...
		menu.add(editor.bind(mxResources.get("toFront"), mxGraphActions.getToFrontAction(), "/images/tofront.gif"));
	...
	public static void populateFormatMenu(JMenu menu, BasicGraphEditor editor) {
		...
		submenu.add(editor.bind(mxResources.get("linecolor"),
				new ColorAction("Linecolor", mxConstants.STYLE_STROKECOLOR), "/images/linecolor.gif"));
		...
		// "/images/entity.gif"));
		// submenu.add(editor.bind(mxResources.get("arrow"), new
		// SetStyleAction("arrow"), "/images/arrow.gif"));
		 ...
		 * KeyValueAction(mxConstants.STYLE_STARTARROW,
		 * mxConstants.ARROW_CLASSIC), "/images/classic_start.gif"));
		 * submenu.add(editor.bind(mxResources.get("block"), new
		 * KeyValueAction(mxConstants.STYLE_STARTARROW,
		 * mxConstants.ARROW_BLOCK), "/images/block_start.gif"));
		 * 
		 * submenu.addSeparator();
		 * 
		 * submenu.add(editor.bind(mxResources.get("diamond"), new
		 * KeyValueAction(mxConstants.STYLE_STARTARROW,
		 * mxConstants.ARROW_DIAMOND), "/images/diamond_start.gif"));
		 ...
		 * "/images/open_end.gif"));
		 * submenu.add(editor.bind(mxResources.get("classic"), new
		 * KeyValueAction(mxConstants.STYLE_ENDARROW,
		 * mxConstants.ARROW_CLASSIC), "/images/classic_end.gif"));
		 * submenu.add(editor.bind(mxResources.get("block"), new
		 ...
		 * submenu.add(editor.bind(mxResources.get("diamond"), new
		 * KeyValueAction(mxConstants.STYLE_ENDARROW,
		 * mxConstants.ARROW_DIAMOND), "/images/diamond_end.gif"));
		 * submenu.add(editor.bind(mxResources.get("oval"), new
		...
		submenu.add(editor.bind(mxResources.get("left"),
				new KeyValueAction(mxConstants.STYLE_ALIGN, mxConstants.ALIGN_LEFT), "/images/left.gif"));
		submenu.add(editor.bind(mxResources.get("center"),
				new KeyValueAction(mxConstants.STYLE_ALIGN, mxConstants.ALIGN_CENTER), "/images/center.gif"));
		submenu.add(editor.bind(mxResources.get("right"),
				new KeyValueAction(mxConstants.STYLE_ALIGN, mxConstants.ALIGN_RIGHT), "/images/right.gif"));

		submenu.addSeparator();

		submenu.add(editor.bind(mxResources.get("top"),
				new KeyValueAction(mxConstants.STYLE_VERTICAL_ALIGN, mxConstants.ALIGN_TOP), "/images/top.gif"));
		submenu.add(editor.bind(mxResources.get("middle"),
				new KeyValueAction(mxConstants.STYLE_VERTICAL_ALIGN, mxConstants.ALIGN_MIDDLE), "/images/middle.gif"));
		submenu.add(editor.bind(mxResources.get("bottom"),
				new KeyValueAction(mxConstants.STYLE_VERTICAL_ALIGN, mxConstants.ALIGN_BOTTOM), "/images/bottom.gif"));
	...
	// model.getValue(aGraph.getTerminal(cutEdges[i], true))) + "-"
	// + Integer.parseInt((String)
	// model.getValue(aGraph.getTerminal(cutEdges[i], false))));
	// }
	//
	// System.out.println(" ]");
	// }
	...
	// try
	// {
	// //only this line is needed to get the result from Floyd-Roy-Warshall, the
	// rest is code for displaying the result
	// FWIresult = mxTraversal.floydRoyWarshall(aGraph);
	//
	// Object[][] dist = FWIresult.get(0);
	// Object[][] paths = FWIresult.get(1);
	// Object[] vertices =
	// aGraph.getChildVertices(aGraph.getGraph().getDefaultParent());
	...
	// costFunction.getCost(view.getState(vertices[0])) + " to "
	// + costFunction.getCost((view.getState(vertices[vertexNum - 1]))) + "
	// is:");
	//
