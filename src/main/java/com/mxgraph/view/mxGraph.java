...
public class mxGraph extends mxEventSource {
	...
	/**
	 * Holds the version number of this release. Current version is 3.5.1.3.
	 */
	...
	public Object[] getSelectionCellsForChanges(List<mxUndoableChange> changes) {
		...
		while (it.hasNext()) {
			...
			else if (change instanceof protegeEntityChange) {
				cells.add(((protegeEntityChange) change).getCell());
	...
	public mxRectangle processChange(mxUndoableChange change, boolean invalidate, boolean ignoreDirty) {
		...
		if (change instanceof mxRootChange) {
			...
			Object cell = ((protegeEntityChange) change).getCell();
	...
	public Object createGroupCell(Object[] cells) {
		mxCell group = new mxCell("", new mxGeometry(), null, null);
	...
	public Object insertVertex(Object parent, String id, Object value, double x, double y, double width, double height,
			String style, CustomEntityType entityType) {
		// System.out.println("sarker.3 mxGraph.java");
		return insertVertex(parent, id, value, x, y, width, height, style, entityType, false);
	}
	 ...
	 */
	public Object insertVertex(Object parent, String id, Object value, double x, double y, double width, double height,
			String style, CustomEntityType entityType, boolean relative) {
		// System.out.println("sarker.3 mxGraph.java insertVertex");
		Object vertex = createVertex(parent, id, value, x, y, width, height, style, entityType, relative);
	...
	public Object createVertex(Object parent, String id, Object value, double x, double y, double width, double height,
			String style, CustomEntityType entityType) {
		return createVertex(parent, id, value, x, y, width, height, style, entityType, false);
	}
	...
	public Object createVertex(Object parent, String id, Object value, double x, double y, double width, double height,
		...
		mxCell vertex = new mxCell(value, geometry, style, entityType);
		vertex.setId(id);
	 ...
	 * Creates and adds a new edge with an empty style.
	 */
	public Object insertEdge(Object parent, String id, Object value, Object source, Object target,CustomEntityType entityType) {
		return insertEdge(parent, id, value, source, target, null,entityType);
	}
	 ...
	 */
	public Object insertEdge(Object parent, String id, Object value, Object source, Object target, String style,CustomEntityType entityType) {
		Object edge = createEdge(parent, id, value, source, target, style, entityType);
	...
	public Object createEdge(Object parent, String id, Object value, Object source, Object target, String style,CustomEntityType entityType) {
		mxCell edge = new mxCell(value, new mxGeometry(), style,entityType);
	...
	public void cellsAdded(Object[] cells, Object parent, Integer index, Object source, Object target,
			boolean absolute) {
		// System.out.println("sarker.3 cellsAdded called."
		// +((mxCell)cells[0]).getValue());
	 ...
	 * <mxEvent.CELLS_RESIZED> event. If extendParents is true, then the parent
	 * is extended if a child size is changed so that it overlaps with the
	 * parent.
	 * 
	 * @param cells
	 ...
	 * <labelsVisible> is true. Otherwise it returns an empty string.
	 * 
	 * @param cell
