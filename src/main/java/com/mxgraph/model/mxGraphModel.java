...
public class mxGraphModel extends mxEventSource implements mxIGraphModel, Serializable {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.mxgraph.model.mxIGraphModel#getEntityType(Object)
	 */
	// sarker.3 codec impl
	public CustomEntityType getEntityType(Object cell) {
		return (cell instanceof mxICell) ? ((mxICell) cell).getEntityType() : null;
	}

	/*
	 * (non-Javadoc)
	 * 
	 * @see com.mxgraph.model.mxIGraphModel#setEntityType(Object, Object)
	 */
	// sarker.3 codec impl
	public CustomEntityType setEntityType(Object cell, CustomEntityType value) {
		execute(new protegeEntityChange(this, cell, value));
	...
	/**
	 * Inner callback to update the entityType of the given mxCell using
	 * mxCell.getEntityType and return the previous value, that is, the return
	 * value of mxCell.getEntityType.
	 */
	// sarker.3 codec impl
	...
	public static class protegeEntityChange extends mxAtomicGraphModelChange {
		...
		public void execute() {
			...
			previous = ((mxGraphModel) model).entityTypeForCellChanged(cell, previous);
		}
