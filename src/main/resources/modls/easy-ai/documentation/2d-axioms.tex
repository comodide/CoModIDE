...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=.8\textwidth]{images/schema-diagrams/2d-elementary-pattern.pdf}
\end{center}
\caption{Schema Diagram for the 2d-EASY-AI pattern. %The visual notation is explained in Chapter \ref{chap:prelims}.
}
\label{fig:2d}
\end{figure}
\subsection{Summary}
Pattern 2d has a process-type transform-embed that accepts the InputRole of an artifact-type symbol and model-type semantic to produce an OutputRole of artifact-type data.
\label{sum:2d}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Description of 1a-d
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
