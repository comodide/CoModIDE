...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=.8\textwidth]{images/schema-diagrams/2c-elementary-pattern.pdf}
\end{center}
\caption{Schema Diagram for the 2c-EASY-AI pattern. %The visual notation is explained in Chapter \ref{chap:prelims}.
}
\label{fig:2c}
\end{figure}
\subsection{Summary}
Pattern 2c has a process-type infer-deduction that accepts the InputRole of either an artifact-type data or artifact-type symbol and a model to produce an OutputRole of a model.
\label{sum:2c}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Description of 1a-d
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
