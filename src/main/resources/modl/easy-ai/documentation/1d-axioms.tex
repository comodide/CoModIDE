...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=.8\textwidth]{images/schema-diagrams/1d-elementary-pattern.pdf}
\end{center}
\caption{Schema Diagram for the 1d-EASY-AI pattern. %The visual notation is explained in Chapter \ref{chap:prelims}.
}
